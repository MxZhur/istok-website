                        ...
                        <template v-else>
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('login')"> Вход </DropdownLink>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="px-4">
                        <div class="font-medium text-base text-gray-800">
                            {{ $page.props.auth.user ? $page.props.auth.user.name : 'Профиль' }}
                        </div>
                    </div>

                    <div v-if="$page.props.auth.user" class="mt-3 space-y-1">
                        <ResponsiveNavLink :href="route('profile.edit')"> Профиль </ResponsiveNavLink>
                        <ResponsiveNavLink v-if="$page.props.auth.user.is_admin" :href="route('admin.index')"> Админ.
                            панель
                        </ResponsiveNavLink>
                    ...
                    <div v-else class="mt-3 space-y-1">
                        <ResponsiveNavLink :href="route('login')"> Вход </ResponsiveNavLink>
