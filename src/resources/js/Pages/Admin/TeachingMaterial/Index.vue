...
import TeachingMaterialSearchForm from './Partials/TeachingMaterialSearchForm.vue';
...
<template>
    ...
    <Head title="Управление материалами для учителей" />
        ...
        <template #heading>
            <div class="flex flex-row justify-between items-center">
                <div class="flex flex-col justify-start items-start sm:flex-row sm:justify-start sm:items-center ">
                    <div class="mr-4">
                        Управление материалами для учителей
                    </div>
                    <Link :href="route('admin.teaching_materials.create')">
                    <PrimaryButton>
